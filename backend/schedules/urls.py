...
from .views import (
    ...
    DailyPlaceCreateView, DailyPlaceDetailView, DailyPlaceBulkReorderView,
...
urlpatterns = [
    ...
    path('schedules/<int:pk>/places/reorder/', DailyPlaceBulkReorderView.as_view(), name='dailyplace-reorder'),
