...
const MOCK_PLACE_2: Place = {
  ...
  category: '12',
  is_verified: true,
  kakao_place_url: 'https://place.map.kakao.com/2',
  is_bookmarked: false,
  rating: 4.7,
  like_count: 3400,
...
const MOCK_PLACE_3: Place = {
  ...
  category: '14',
  is_verified: true,
  kakao_place_url: 'https://place.map.kakao.com/3',
  is_bookmarked: true,
  rating: 4.5,
  like_count: 8900,
...
const MOCK_PLACE_4: Place = {
  ...
  category: '14',
  is_verified: true,
  kakao_place_url: 'https://place.map.kakao.com/4',
  is_bookmarked: false,
  rating: 4.2,
  like_count: 5600,
...
const MOCK_PLACE_5: Place = {
  ...
  category: '14',
  is_verified: true,
  kakao_place_url: 'https://place.map.kakao.com/5',
  is_bookmarked: false,
  rating: 4.6,
  like_count: 12300,
...
const MOCK_PLACE_6: Place = {
  ...
  category: '15',
  is_verified: true,
  kakao_place_url: 'https://place.map.kakao.com/6',
  is_bookmarked: false,
  rating: 4.0,
  like_count: 3200,
